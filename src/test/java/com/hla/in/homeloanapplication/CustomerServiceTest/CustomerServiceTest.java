package com.hla.in.homeloanapplication.CustomerServiceTest;
...
@SpringBootTest
 class CustomerServiceTest {
	...
	private static ICustomerRepository customerService;
	...
	public void doinit()
	{
	      ...
	      customerService = new  ICustomerRepository(customerRepo); 	// Approach 2
	...
	void testViewCustomerById() throws CustomerNotFoundException {
		...
		Optional<Customer> customer_test = Optional.of(customerService.viewCustomerbyId(input));
